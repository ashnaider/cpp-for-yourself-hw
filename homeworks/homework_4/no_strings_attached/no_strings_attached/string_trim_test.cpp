...
TEST(Trim, TrimTestBothSides) {
    std::string lhs = "   abc   ";
    std::string rhs = "abc";
    EXPECT_EQ(no_strings_attached::string_trim::Trim(lhs), rhs);
}
...
TEST(Trim, TrimTestRightSideOnly) {
    std::string lhs = "    abc";
    std::string rhs = "    abc";
    EXPECT_EQ(no_strings_attached::string_trim::Trim(lhs, ' ', no_strings_attached::string_trim::Side::kRight), rhs);
}

TEST(Trim, TrimTestLeftSideOnly) {
    std::string lhs = "abc    ";
    std::string rhs = "abc    ";
    EXPECT_EQ(no_strings_attached::string_trim::Trim(lhs, ' ', no_strings_attached::string_trim::Side::kLeft), rhs);
}
